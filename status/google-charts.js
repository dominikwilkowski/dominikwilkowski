(function () {
	var aa = "\n//# sourceURL=",
		...
		xa = "Puerto Rico",
		ya = "Rep\u00fablica Dominicana",
		B = "Rwanda",
		za = "Rywvaneth Unys",
		Aa = "R\u00e9publique centrafricaine",
		Ba = "R\u00e9publique d\u00e9mocratique du Congo",
		Ca = "Saint Kitts and Nevis",
		Da = "Saint Vincent and the Grenadines",
		Ea = "Saint-Pierre-et-Miquelon",
		Fa = "Serbia and Montenegro",
		Ga = "Seychelles",
		Ha = "Slovensk\u00e1 republika",
		Ia = "Solomon Islands",
		C = "South Africa",
		Ja = "Svalbard og Jan Mayen",
		Ka = "Swaziland",
		La = "S\u00e3o Tom\u00e9 e Pr\u00edncipe",
		D = "S\u00e9n\u00e9gal",
		Ma = "Tanzania",
		Na = "Timor Leste",
		F = "Tokelau",
		Oa = "Turks and Caicos Islands",
		G = "Tuvalu",
		H = "T\u00fcrkiye",
		Pa = "U.S. Virgin Islands",
		Qa = "United Kingdom",
		Ra = "United States",
		Sa = "United States Minor Outlying Islands",
		Ta = "Unknown or Invalid Region",
		I = "Vanuatu",
		Ua = "Wallis-et-Futuna",
		Va = "annotatedtimeline",
		J = "array",
		K = "browserchart",
		L = "complete",
		M = "corechart",
		...
		S = "ui_base",
		T = "webfontloader",
		Ya = "{css_prefix}/{cssFile}",
		Za = "{prefix}",
		$a = "{prefix}/{version}/third_party/{package}",
		ab = "{version}",
		bb = "\u010cesk\u00e1 republika",
		cb = "\u0411\u0435\u043b\u0430\u0440\u0443\u0441\u044c",
		db = "\u041a\u044b\u0440\u0433\u044b\u0437\u0441\u0442\u0430\u043d",
	...
	Z.Wa &&
		...
		(Z.Ec = function () {
			if (Z.O(Z.global.Mb)) Z.B = Z.global.Mb;
				...
				for (
					var a = Z.global.document.getElementsByTagName("SCRIPT"),
						c = a.length - 1;
					0 <= c;
					--c
				) {
		...
		(Z.Ra = []),
		(Z.Gg = function (a, c) {
			return Z.Wb && Z.O(Z.global.JSON)
				? "goog.loadModule(" + Z.global.JSON.stringify(c + aa + a + "\n") + ");"
		...
		(Z.wb = function (a) {
			...
			return a && ("goog" == c.module || Z.Bb(c.lang)) ? Z.B + a in Z.j.W : !1;
		}),
		(Z.qc = function (a) {
			if ((a = Z.Fa(a)) && a in Z.j.F)
				for (var c in Z.j.F[a]) if (!Z.Qc(c) && !Z.wb(c)) return !1;
			return !0;
		}),
		(Z.Ab = function (a) {
			if (a in Z.j.W) {
				...
				void 0 === c
					? Z.Vb
						? ((c =
								...
								++Z.yb +
								")' "),
							d.write(ba + a + '"' + c + ">\x3c/script>"))
						: Z.Ya
							? Z.rc(a)
							: Z.vd(a)
					: d.write('<script type="text/javascript">' + c + "\x3c/script>");
				return !0;
			}
			return !1;
		}),
	...
	Z.yf = function (a) {
		...
		try {
			...
			else if (Z.h(a)) d = Z.Vc.call(void 0, a);
	...
	Z.Jc = function (a) {
		if (Z.global.execScript) Z.global.execScript(a, "JavaScript");
			...
			if (null == Z.X)
				if (
					(Z.global.eval("var _evalTest_ = 1;"),
	...
	Z.b.Gb = function (a) {
		return Z.b.contains(a, "&")
			? !Z.b.Sb && "document" in Z.global
				? Z.b.Hb(a)
				: Z.b.rd(a)
			: a;
	};
	...
	Z.b.Hb = function (a, c) {
		...
		return a.replace(Z.b.Ub, function (a, c) {
			...
			"#" == c.charAt(0) &&
				...
				isNaN(c) || (h = String.fromCharCode(c)));
	...
	Z.b.repeat = String.prototype.repeat
		? function (a, c) {
				return a.repeat(c);
			}
		: function (a, c) {
	...
	Z.b.Ue = function () {
		return (
			...
			Math.abs(Math.floor(2147483648 * Math.random()) ^ Z.now()).toString(36)
		);
	};
	Z.b.ye = function (a, c) {
		var d = 0;
		...
		for (var e = Math.max(a.length, c.length), f = 0; 0 == d && f < e; f++) {
			...
			do {
				...
				d =
					...
					Z.b.qa(0 == n[2].length, 0 == r[2].length) ||
					Z.b.qa(n[2], r[2]);
			} while (0 == d);
		}
		return d;
	...
	Z.f.wf = Z.f.dd;
	Z.f.indexOf =
		Z.w && (Z.f.v || Array.prototype.indexOf)
			? function (a, c, d) {
	...
	Z.f.lastIndexOf =
		Z.w && (Z.f.v || Array.prototype.lastIndexOf)
			? function (a, c, d) {
	...
	Z.f.forEach =
		Z.w && (Z.f.v || Array.prototype.forEach)
			? function (a, c, d) {
					Array.prototype.forEach.call(a, c, d);
				}
			: function (a, c, d) {
					for (
						var e = a.length, f = Z.h(a) ? a.split("") : a, g = 0;
						g < e;
						g++
					)
	...
	Z.f.filter =
		Z.w && (Z.f.v || Array.prototype.filter)
			? function (a, c, d) {
	...
	Z.f.map =
		Z.w && (Z.f.v || Array.prototype.map)
			? function (a, c, d) {
					return Array.prototype.map.call(a, c, d);
				}
			: function (a, c, d) {
					for (
						var e = a.length, f = Array(e), g = Z.h(a) ? a.split("") : a, h = 0;
						h < e;
						h++
					)
	...
	Z.f.reduce =
		Z.w && (Z.f.v || Array.prototype.reduce)
			? function (a, c, d, e) {
					e && (c = Z.bind(c, e));
	...
	Z.f.reduceRight =
		Z.w && (Z.f.v || Array.prototype.reduceRight)
			? function (a, c, d, e) {
					e && (c = Z.bind(c, e));
	...
	Z.f.some =
		Z.w && (Z.f.v || Array.prototype.some)
			? function (a, c, d) {
	...
	Z.f.every =
		Z.w && (Z.f.v || Array.prototype.every)
			? function (a, c, d) {
	...
	Z.f.insertBefore = function (a, c, d) {
		var e;
		2 == arguments.length || 0 > (e = Z.f.indexOf(a, d))
			? a.push(c)
			: Z.f.tb(a, c, e);
	};
		...
		for (var c = [], d = 0; d < arguments.length; d++) {
			...
			if (Z.isArray(e))
				for (var f = 0; f < e.length; f += 8192)
					for (
						var g = Z.f.Gc.apply(null, Z.f.slice(e, f, f + 8192)), h = 0;
						h < g.length;
						h++
					)
						c.push(g[h]);
	...
	Z.locale.mb = function (a) {
		return (a = a.match(/[-_]([a-zA-Z]{2}|\d{3})([-_]|$)/))
			? a[0].replace(/[_-]/g, "")
			: "";
	};
	...
	Z.locale.Ve = function (a, c) {
		...
		if (a in Z.locale.m) {
			...
			c = c.split("_");
			return 1 < c.length && c[0] in Z.locale.m[a]
				? Z.locale.m[a][c[0]]
				: Z.locale.m[a].en;
		}
	};
		...
		if (c)
			if ("undefined" === typeof a.onload) {
				...
				a.onreadystatechange = function () {
					d ||
						(a.readyState && a.readyState !== L
							? google.a.c.window.setTimeout(a.onreadystatechange, 0)
							: ((d = !0),
		...
		if (0 === a.length) c();
			...
			var nb = function (c) {
				...
				if (e) {
					...
					E
						? ((f = E),
							e === T && (d = window.document),
							(e = google.a.c.i.third_party))
						: google.a.c.Eb[e]
							? ((f = google.a.c.Eb[e]), (e = google.a.c.i.third_party_gen))
							: (e = google.a.c.Y ? h : r ? m : l);
					f = e
						.replace(Za, g)
						.replace(ab, n)
						.replace("{language}", r)
	...
	google.a.c.V = function (a) {
		...
		"undefined" !== typeof n.addEventListener
			? (n.addEventListener("load", c, !1), n.addEventListener("error", d, !1))
			: "undefined" !== typeof n.attachEvent &&
				...
				h = function (a) {
					...
					n =
						a < d.length - 1
							...
							: c;
					google.a.c.P[m]
						? (google.a.c.log("Already loaded " + m),
							google.a.c.window.setTimeout(n, 0))
						: ((google.a.c.P[m] = !0),
							(m = f
								.replace("{css_prefix}", google.a.c.i.css_prefix)
								.replace(Za, e)
								.replace(ab, g)
								.replace("{cssFile}", m)),
							google.a.c.Sc(m, n));
	...
	google.a.c.Cb = function (a) {
		...
		c ||
			(a.match(/_[^_]+$/)
				? ((a = a.replace(/_[^_]+$/, "")), (a = google.a.c.Cb(a)))
				: (a = "en"));
		return a;
	};
	google.a.c.ed = function (a, c) {
		...
		if (
			(google.a.c.I && google.a.c.I !== a) ||
			(google.a.c.Ma && google.a.c.Ma !== e) ||
			google.a.c.Y !== d
		)
			google.a.c.P = {};
		google.a.c.I = a;
			...
			if (null == e)
				(f = function () {
					...
					google.a.c.ea
						? ((google.a.c.ea = !1),
							google.a.c.zb(
								google.a.c.i.prefix + "/" + a + "/loader.js",
								window.document,
								f,
							))
						: f();
				...
				google.visualization.CssPath = google.a.c.i.css_prefix
					.replace(Za, google.a.c.i.prefix)
					.replace(ab, google.a.c.I);
				google.a.c.window = window;
